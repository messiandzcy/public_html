...
$accesstoken='234030|6.8565308d239d907521e9ff1540bd2c78.2592000.1370757600-524041877';//测试用户就是我自己。。
...
$params = array('page'=>'1',
				'count'=>'2',
				'access_token'=>$accesstoken);//使用access_token调api的情况
...
/*$params = array('name'=>"测试",
				'description'=>"哈工大自然计算研究室",
				'url'=>"http://nclab.hit.edu.cn",
				'image'=>"http://nclab.hit.edu.cn/wechat/nacha1.jpg",
				'action_name'=>"百度",
				'action_link'=>"http://www.baidu.com",
				'message'=>"message_test",
				'access_token'=>$accesstoken);//使用access_token调api的情况
*/

$params = array('method'=>"status.set",
				'status'=>"everything's gonna be OK\n",
				//'place_id'=>"窝工",
